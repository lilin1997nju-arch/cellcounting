...
5. The learned temporal evidence model consumes aligned T0/T1/T2 raw patches, masks, displacement, area change, and multiplicity. It outputs same-object, cell/debris evidence and insufficient probabilities; V2 no longer emits or applies a dead-cell decision. Low-confidence or unsupported classes abstain as `insufficient`.
